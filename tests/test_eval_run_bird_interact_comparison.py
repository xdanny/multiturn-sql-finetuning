...
def test_run_bird_interact_comparison_validates_and_compares(tmp_path, monkeypatch) -> None:
    ...
    contract_manifest = tmp_path / "bird.contract.manifest.json"
    ...
    _write_json(
        ...
        {
            "benchmark": "bird_interact_transfer",
            "output_path": "docs/data_artifacts/bird_interact_transfer_rows.jsonl",
            "output_sha256": "bird-sha",
        },
    )

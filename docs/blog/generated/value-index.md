...
| value_index_cosql_dev_100_summary.json | resolved_value_indexed_rate | 0.783 | Share of gold SQL literal values present in the database-derived index. |
| value_index_cosql_dev_100_summary.json | mention_alias_indexed_rate | 0.755 | Share of user-visible mentions already recoverable as value-index aliases. |
| value_index_cosql_dev_100_summary.json | resolved_value_indexed_count | 83 | Count of gold resolved values found in the index. |
| value_index_cosql_dev_100_summary.json | mention_alias_indexed_count | 80 | Count of user mentions found as index aliases. |

"""
Reference-SQL-derived labels for scorer-side schema linking analysis.

These labels are extracted after the answer key is known. They are useful for
failure taxonomy and supervised data analysis, but they are not prompt inputs.
"""
